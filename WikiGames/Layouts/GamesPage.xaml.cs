...
namespace WikiGames
{
    public partial class GamesPage : ContentPage
    {
        ...
        {
            InitializeComponent();
            GamesPage.RestClient = new HttpClient(new Dictionary<string, string>
            {
        ...
        private async void fechtJuegos()
        {
            ...
            ///
            listJuegos = await GamesPage.RestClient.GetAsync<List<Juego>>("https://informatica.ieszaidinvergeles.org:9062/proyecto/public/api/juego");
