...
namespace WikiGames.Layouts.Home
{
    public partial class HomePage : ContentPage
    {
        ...
        {
            InitializeComponent();
            RestClient = new HttpClient(new Dictionary<string, string>
            {
        ...
        private async void fechtJuegos()
        {
            ...
            ///
            listJuegos = await RestClient.GetAsync<List<Juego>>("https://informatica.ieszaidinvergeles.org:9062/proyecto/public/api/juego");
